	...
	plugin.trial = function(display_element, trial)
	{
		...
		display_element.load(SITE_PREFIX + "/utils/ticket-choose.php", function()
		{
            ...
            */
            ...
            average_price = 0.05*Math.round(20*trial.mean_price); //0.5*Math.round(2*average_price);
				...
				if(price_num < num_prices)
				{
					...
					ticket_main.animate({ opacity: "0" }, 200, function() {
                        ...
                        if(r === 0) {
                            ...
                            above.html("Congratulations! You chose the best price for this product!");
                        }
                        else {
...
*/                          prefix += r+1;
                            ...
                            above.html(prefix + " best price for this product.");
                        }
