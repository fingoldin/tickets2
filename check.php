...
function checkAnswer($phase, $group, $sequence, $answer, $idx)
{
...
if(isset($_POST["phase"]) && isset($_POST["group"]) && isset($_POST["sequence"]) && isset($_POST["answer"]) && isset($_POST["idx"]))
	checkAnswer(intval($_POST["phase"]), intval($_POST["group"]), intval($_POST["sequence"]), intval($_POST["answer"]), intval($_POST["idx"]));
else
