...
<div id="risk-main">
    ...
    <p style="margin: 15px">
        Now, consider you're at the casino. Here is a spinner, which you can spin up to <span id="risk-count"></span> times. Each time you spin it, you can either accept the result as a reward, or spin the spinner again in hopes of a higher reward.
